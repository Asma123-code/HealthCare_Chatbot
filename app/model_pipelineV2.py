...
class ModelPipeLine:
    ...
    def __init__(self):
        ...
        self.sentiment_model = os.path.join(os.path.dirname(os.path.dirname(self.curr_dir)), 'src','model')
    ...
    def load_model(self):
        ...
        model_path = os.path.join(self.sentiment_model,'sentiment_classifier.pkl')
